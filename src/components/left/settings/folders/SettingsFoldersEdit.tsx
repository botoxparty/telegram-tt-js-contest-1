...
import SettingsFolderNameInput from './SettingsFolderNameInput';
...
const SettingsFoldersEdit: FC<OwnProps & StateProps> = ({
  ...
  const handleFolderEmojiSelect = useCallback(
    (emoji: string) => {
      dispatch({
        type: 'setEmoticon',
        payload: emoji,
      ...
      <div className="settings-content no-border custom-scroll">
        <div className="settings-content-header">
          ...
          <div className="folder-name-input-container">
            <SettingsFolderNameInput
              value={state.folder.title.text}
              error={state.error === ERROR_NO_TITLE ? ERROR_NO_TITLE : undefined}
              label={lang('FilterNameHint')}
              onChange={handleChange}
              className="mb-0"
            />
            <SettingsFolderIconPicker
              value={state.folder.emoticon}
              onChange={handleFolderEmojiSelect}
            />
          </div>
        </div>
